...
function IsGameDay() {
    ...
    if ((day == 0 && hour >= 11 && hour <= 23) || (day == 1 && hour >= 18 && hour <= 22) || (day == 4 && hour >= 18 && hour <= 22) || (day == 6 && hour >= 12 && hour <= 23) || (day == 5 && hour >= 18 && hour <= 22) || (isThanksgiving())) { console.log("GAME DAY"); return 'true'; }
    else
        return 'false';
}
